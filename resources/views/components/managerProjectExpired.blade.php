<section>
    <div class="border-y py-4 flex justify-between">
        <div>
            <p class="text-3xl montserrat-semibold text-gray-700">Expired Project</p>
        </div>
    ...
    <div class="border-b">
        <div class="grid grid-cols-6 py-2">
            ...
            <div class="text-xs montserrat-regular text-gray-600">Start Date</div>
            <div class="text-xs montserrat-regular text-gray-600">End Date</div>
        </div>
        <!-- Details rows -->
        @for ($i = 1; $i <= 15; $i++)
        <div class="grid grid-cols-6 py-4 border-t">
