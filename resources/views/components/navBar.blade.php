<div class=" w-full gap-3 z-10 py-2 sticky right-0 left-0 top-0 bg-background items-center flex justify-end px-3">
    ...
    <div class="flex justify-end gap-2 ">
        <div class="flex gap-2 text-xs items-center">
            ...
            <a href="/project?projectloc=add" class="px-3 py-3   text-center  items-center  rounded-md gap-1 montserrat-semibold bg-emerald-400 text-white  hidden md:flex">
                <span>
