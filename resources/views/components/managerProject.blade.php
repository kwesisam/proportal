            ...
            <div id="projectList" class="hidden">
                ...
                <div class="h-[90vh]">
                    <!-- Details rows -->
                        ...
                        <a  href="{{ route('project.info', $projects[$i]->id) }}">
                                    ...
                                    <div x-show="modalOpen"
                                        ...
                                        <form id="addproject" name="addproject">
                                            <div class="relative w-full pb-8 space-y-2">
                                                <input id="project_name" name="project_name" type="text" class="w-full p-2 border outline-none text-sm rounded-md">
                                            ...
                                            <div class="flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2">
                                                ...
                                                <button type="button" id="createBtn" class="inline-flex items-center justify-center h-10 px-4 py-2 text-sm font-medium text-white transition-colors border border-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-900 focus:ring-offset-2 bg-emerald-950 hover:bg-emerald-900">
