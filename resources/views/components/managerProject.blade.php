...
<section class="shadow-md bg-gray-50 dark:bg-neutral-900 p-2 rounded-md h-[89h]">
    <div class="">
         <div class="py-4 flex justify-between">
            <div>
                <div>
                    <ol class="flex text-lg md:text-2xl items-center whitespace-nowrap  montserrat-semibold header focus:outline-none" aria-current="page">
                                ...
                                <div class="shadow dark:shadow-rose-100 p-2 rounded-md flex-col projects cursor-pointer" data-type="projects" data-project-id="{{ $projects[$i]->id }}" >
                                    <div class="flex justify-between">
                                        <div  class="flex items-center w-[80%] gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-folder-closed header">
                                                <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
                                                <path d="M2 10h20" />
                                            </svg>
                                            <span class="w-[80%] truncate header select-none montserrat-regular">
                                                {{ $projects[$i]->name }}
                                            </span>
                                        </div>
                                        <div class="hs-tooltip [--trigger:click] [--placement:left] inline-block">
            ...
            <template x-teleport="body">
                <div x-show="contextMenuOpen" @click.away="contextMenuOpen=false" x-ref="contextmenu" class="z-50 min-w-[8rem] text-neutral-800 rounded-md border border-neutral-200/70 bg-white text-sm fixed p-1 shadow-md w-64" x-cloak>
                    <div @click="contextMenuOpen=false" class="relative select-none group items-center rounded px-2 py-1.5 cursor-pointer outline-none pl-2 data-[disabled]:opacity-50">
                        <x-model>
                            <div @click="modalOpen=true" class="inline-flex items-center gap-2 montserrat-regular justify-start transition-colors focus:outline-none focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none w-full ">
                                <span>
                                ...
                                <span class="select-none">New Project</span>
                            </div>
                            <template x-teleport="body">
                                <div x-show="modalOpen" class="fixed top-0 left-0 z-[99] flex items-center justify-center w-screen h-screen" x-cloak>
                                    ...
                                    <div x-show="modalOpen"
                                        ...
                                        class="relative w-full py-6 bg-white dark:bg-gray-50 border shadow-lg px-7 border-neutral-200 sm:max-w-sm sm:rounded-lg">
                                        <div class="flex items-center justify-between pb-3">
                                            <h3 class="text-lg font-semibold select-none">New Project</h3>
                                        ...
                                        <form id="addproject" name="addproject">
                                            <div class="relative w-full pb-8 space-y-2">
                                                <input id="project_name" name="project_name" type="text" class="w-full p-2 border outline-none text-sm rounded-md focus:border-primary">
                                                <p class="text-xs text-red-500 hidden"></p>
                                            </div>
                                            <div class="flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2">
                                                <button @click="modalOpen=false" type="button" class="inline-flex items-center justify-center h-10 px-4 py-2 text-sm font-medium transition-colors border rounded-md focus:outline-none">Cancel</button>
                                                <button type="button" id="createBtn" class="inline-flex items-center justify-center h-10 px-4 py-2 text-sm font-medium text-white transition-colors border border-transparent rounded-md focus:outline-none  bg-primary hover:opacity-90">
